...
public class WebServer {
    private static final String RESOURCE_URL = "http://cmput301.softwareprocess.es:8080/cmput301f15t09/user3/";
    // Specifies the limit size of elastic search (its default = 10)
    private static final String SEARCH_URL = "http://cmput301.softwareprocess.es:8080/cmput301f15t09/user3/_search?size=1000000";

    private static final String RESOURCE_PHOTO_URL = "http://cmput301.softwareprocess.es:8080/cmput301f15t09/photo3/";
    private static final String SEARCH_PHOTO_URL = "http://cmput301.softwareprocess.es:8080/cmput301f15t09/photo3/_search?size=1000000";
